...
# Modified the code to include prediction for year 2023.
...
print ("In California, 2023 will be a", "bad year with a lot of wildfires" if (model.predict([input23]) > 0.5) else "good year with little wildfires")
